...
test vld1q_u8 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_u8, .expected = expected, .args = .{addr} });
}
...
test vld1q_u16 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_u16, .expected = expected, .args = .{addr} });
}
...
test vld1q_u32 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_u32, .expected = expected, .args = .{addr} });
}
...
test vld1q_u64 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_u64, .expected = expected, .args = .{addr} });
}
...
test vld1q_s8 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_s8, .expected = expected, .args = .{addr} });
}
...
test vld1q_s16 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_s16, .expected = expected, .args = .{addr} });
}
...
test vld1q_s32 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_s32, .expected = expected, .args = .{addr} });
}
...
test vld1q_s64 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_s64, .expected = expected, .args = .{addr} });
}
...
test vld1q_f32 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_f32, .expected = expected, .args = .{addr} });
}
...
test vld1q_f64 {
    ...
    try common.testIntrinsic(.{ .func = vld1q_f64, .expected = expected, .args = .{addr} });
}
...
test vst1q_u8 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_u8, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_u16 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_u16, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_u32 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_u32, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_u64 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_u64, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_s8 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_s8, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_s16 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_s16, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_s32 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_s32, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_s64 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_s64, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_p8 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_p8, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_p16 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_p16, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_p46 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_p46, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_f32 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_f32, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
...
test vst1q_f64 {
    ...
    try common.testIntrinsic(.{ .func = vst1q_f64, .expected = expected, .args = .{ result[0..].ptr, vec }, .result_ptr = &result });
}
